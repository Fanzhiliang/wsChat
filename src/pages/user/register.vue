	...
	<div class="panel-wrap" v-loading="isLoading">
		<div class="panel-inner">
			...
			<div class="panel">
				...
				<p class="tip">已经有账号了，可以<router-link to="login">登录</router-link>。</p>
				<div class="panel-main">
					...
					<div class="input-row but-row">
						<input type="text" placeholder="验证码" class="small" v-model="obj.code">
					...
					<div class="input-row">
						<input type="password" placeholder="确认密码" v-model="obj.password2">
