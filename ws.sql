...
INSERT INTO `ws_carte` VALUES ('3', '3', '1', 'cyh', '11', '1549586180');
...
INSERT INTO `ws_dynamic` VALUES ('36', '6', '<p>明天开始一定好好当人，继续完成毕业设计。<img src=\"./static/img/fFace/fFace_31.png\" alt=\"face\" data-w-e=\"1\" style=\"width: 18px; height: 18px; margin: 0px 1px; vertical-align: middle;\"></p>', '1546866911', '', '2', '[\"http://www.test3.com/wsChat/resources/6_1546866911_0.jpg\"]');
...
CREATE TABLE `ws_group` (
  ...
  `headPath` varchar(255) NOT NULL,
  PRIMARY KEY (`group_id`),
  UNIQUE KEY `group_account` (`group_account`)
...
INSERT INTO `ws_record` VALUES ('2', '3', '6', 'friendMsg', '37', '0', '0');
INSERT INTO `ws_record` VALUES ('3', '2', '1', 'groupMsg', '69', '1', '0');
INSERT INTO `ws_record` VALUES ('5', '6', '3', 'friendMsg', '37', '1', '0');
INSERT INTO `ws_record` VALUES ('7', '6', '2', 'friendMsg', '91', '1', '0');
INSERT INTO `ws_record` VALUES ('9', '3', '1', 'groupMsg', '69', '0', '0');
INSERT INTO `ws_record` VALUES ('10', '6', '1', 'groupMsg', '69', '1', '0');
INSERT INTO `ws_record` VALUES ('15', '9', '6', 'friendMsg', '81', '1', '0');
INSERT INTO `ws_record` VALUES ('16', '6', '9', 'friendMsg', '78', '1', '0');
INSERT INTO `ws_record` VALUES ('18', '9', '1', 'groupMsg', '69', '1', '0');
...
CREATE TABLE `ws_user` (
  ...
  `sexName` varchar(4) NOT NULL DEFAULT '无',
  `sign` varchar(255) DEFAULT NULL,
  `headPath` varchar(255) DEFAULT NULL,
  `area` varchar(40) DEFAULT NULL,
  `areaArray` varchar(30) DEFAULT NULL,
...
-- Records of ws_user
-- ----------------------------
INSERT INTO `ws_user` VALUES ('2', '546542312', 'xl', '47789.321', '0', '无', '明天会更好~', 'http://www.test3.com/wsChat/resources/1548657410.jpg', '', '', '2281588099@qq.com', '', '438664ea6500b2a5e9e7b4b7b40445bb', '1', '0', '0', '0', null);
INSERT INTO `ws_user` VALUES ('3', '598432145', 'cyh', '47789.321', '0', '无', '拥护党的纲领,遵守党的章程,履行党员义务,执行党的决定,严守党的纪律,保守党的秘密.', 'http://www.test3.com/wsChat/resources/1548657487.jpg', '', '', 'cyh@qq.com', '', 'ce032ecef367be36c1ee0ad14f094f84', '1', '0', '0', '0', null);
INSERT INTO `ws_user` VALUES ('6', '529055786', 'fzl', '47789.321', '1', '男', '我也能找到吗？在仅有一次的生命里。', 'http://www.test3.com/wsChat/resources/1549178295.jpg', '广东省 广州市 南沙区', '[\"44\",\"4401\",\"440115\"]', '505911050@qq.com', '13128269543', '46b4e29d09b68aa5880e10194f57dcff', '1', '0', '0', '22', 'http://ws.alcyh.com/resources/6_1551775042_0.jpg,http://ws.alcyh.com/resources/6_1551775186_0.png');
INSERT INTO `ws_user` VALUES ('9', '562314794', 'xxl', '47789.321', '0', '无', null, './static/img/user-head.png', null, null, 'xxl@qq.com', null, '266e750b217a91c846c7fae26e2e33ba', '1', '0', '0', '0', 'http://ws.alcyh.com/resources/9_1552129076_0.jpg');
